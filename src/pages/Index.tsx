        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-foreground">Lovable Words</span>
            </div>
      ...
      <footer className="border-t border-border mt-24 py-12 bg-card/30">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-foreground">Lovable Words</span>
              </div>
              <p className="text-muted-foreground text-sm">
                Kelime öğrenmeyi eğlenceli ve etkili hale getiren platform
              </p>
            </div>
          ...
          <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground text-sm">
            <p>&copy; 2024 Lovable Words. Tüm hakları saklıdır.</p>
          </div>
        </div>
      </footer>
    </div>
